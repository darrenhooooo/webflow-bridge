...
'en': {
  ...
  daemon_lead: 'Start the local daemon from the project root — pick the way that matches your setup:',
...
'zh-CN': {
  ...
  daemon_lead: '在项目根目录启动本地 daemon — 选择适合你的方式：',
...
'zh-TW': {
  ...
  daemon_lead: '在專案根目錄啟動本機 daemon — 選擇適合你的方式：',
...
'ja': {
  ...
  daemon_lead: 'プロジェクトのルートでローカル daemon を起動 — 環境に合う方法を選んでください：',
...
'ko': {
  ...
  daemon_lead: '프로젝트 루트에서 로컬 daemon을 시작하세요 — 환경에 맞는 방법을 선택하세요:',
...
'fr': {
  ...
  daemon_lead: 'Démarrez le daemon local depuis la racine du projet — choisissez la méthode adaptée :',
...
'de': {
  ...
  daemon_lead: 'Starten Sie den lokalen Daemon im Projektstammverzeichnis — wählen Sie die passende Methode:',
...
'es': {
  ...
  daemon_lead: 'Inicia el daemon local desde la raíz del proyecto — elige la forma que corresponda:',
...
'pt': {
  ...
  daemon_lead: 'Inicie o daemon local na raiz do projeto — escolha o método adequado:',
...
'ru': {
  ...
  daemon_lead: 'Запустите локальный daemon из корня проекта — выберите подходящий способ:',
...
'ar': {
  ...
  daemon_lead: 'شغّل الدايمون المحلي من جذر المشروع — اختر الطريقة المناسبة:',
...
'it': {
  ...
  daemon_lead: 'Avvia il daemon locale dalla radice del progetto — scegli il metodo adatto:',
...
'vi': {
  ...
  daemon_lead: 'Khởi động daemon cục bộ từ thư mục gốc dự án — chọn cách phù hợp:',
...
'th': {
  ...
  daemon_lead: 'เริ่ม daemon ในเครื่องจากโฟลเดอร์รากของโปรเจกต์ — เลือกวิธีที่เหมาะกับคุณ:',
...
'id': {
  ...
  daemon_lead: 'Jalankan daemon lokal dari akar proyek — pilih cara yang sesuai:',
...
'hi': {
  ...
  daemon_lead: 'प्रोजेक्ट रूट से लोकल daemon शुरू करें — अपने सेटअप के अनुसार तरीका चुनें:',
