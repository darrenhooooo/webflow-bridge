...
'ja': {
  ...
  row_page_bad: 'アクティブなタブはデバッグできません',
...
'fr': {
  ...
  item_daemon: 'daemon',
  item_ext: 'Extension',
  item_page: 'Onglet actif',
  row_daemon_bad: 'daemon arrêté',
  row_ext_bad: 'Extension non prête',
  row_page_bad: 'Onglet actif non débogable',
...
'pt': {
  ...
  row_page_bad: 'Aba ativa não depurável',
...
'ru': {
  ...
  item_daemon: 'daemon',
  item_ext: 'Расширение',
  item_page: 'Активная вкладка',
  row_daemon_bad: 'daemon не запущен',
  row_ext_bad: 'Расширение не готово',
  row_page_bad: 'Активная вкладка недоступна для отладки',
...
'ar': {
  ...
  item_ext: 'الإضافة',
  item_page: 'التبويب النشط',
  row_daemon_bad: 'الدايمون لا يعمل',
  row_ext_bad: 'الإضافة غير جاهزة',
  row_page_bad: 'التبويب النشط غير قابل للتصحيح',
...
'vi': {
  ...
  row_page_bad: 'Thẻ hiện tại không thể gỡ lỗi',
...
'th': {
  ...
  row_page_bad: 'แท็บปัจจุบันดีบักไม่ได้',
...
'id': {
  ...
  row_page_bad: 'Tab saat ini tidak dapat di-debug',
...
'hi': {
  ...
  row_page_bad: 'मौजूदा टैब डीबग नहीं किया जा सकता',
