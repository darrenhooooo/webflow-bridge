...
同一批十个浏览器任务、各跑三次、同一台机器：固定命令序列 30/30 全部跑完，合计 11.0 秒、0 模型 token；用 LLM 自主决策的 agent 框架 27/30，合计 915 秒、消耗 150 万 prompt token。方法、原始日志与诚实说明：[docs/BENCH.md](docs/BENCH.md)、[bench/](bench/)。
